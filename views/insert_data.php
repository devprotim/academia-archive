...
if (isset($_POST['add_students'])) {
    ...
    $sql = "INSERT INTO students (id, student_id, first_name, last_name, discipline, topic, superviser, co_superviser, email) 
            VALUES ('$id', '$student_id', '$first_name', '$last_name', '$discipline', '$topic', '$superviser', '$co_superviser', '$email')";
